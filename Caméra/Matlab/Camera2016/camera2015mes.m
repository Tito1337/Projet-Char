...
%--------------------------------------
%
% version à traduire en C++ pour être directement placée sur la raspberry
%
...
%          ¯¯¯¯¯
% Il faudrait veiller à ce que objco.x, .y, .z  soit une matrice de bonne dimension
%   alors seule est nécessaire la ligne
