...
ref = [  0    L    D    H    % ul
         0    0    H    D    % ur
         0    0    0    L];  % dr
XY1ref = [D/2 0]; % coord X,Y du point principal de référence dans le repère du robot
%         __________
...
XYZ2 = [objco4.x(1)  objco4.y(1)  objco4.z(1)]; % Point de référence XYZ: (1er, le plus proche de la caméra)
XY0 = hommat123*[XYZ2 1]'; % Faisons d'abord subir les trois rotations à ce point pour le ramener dans le plan XY du robot
