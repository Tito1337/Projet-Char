...
bool CCamera::setAWBmode(MMAL_PARAM_AWBMODE_T awbmode) // gng
{
	return raspicamcontrol_set_awb_mode(CameraComponent, awbmode);
}

bool CCamera::setEXPOSUREmode(MMAL_PARAM_EXPOSUREMODE_T exposuremode) // gng
{
    return raspicamcontrol_set_exposure_mode(CameraComponent, exposuremode);
}
