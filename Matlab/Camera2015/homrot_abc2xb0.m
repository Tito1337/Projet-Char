...
% Matrice de rotation du vecteur abc vers le vecteur xb0 où x positif, en coordonnées homogènes
...
%             qui serait transformé en un vecteur x,b,0 (puis un 4e) par la matrice de
...
%             permettant d'effectuer la rotation autour de l'axe Y qui annule la coordonnée z
